  ...
  return (
    <>
      <Form.Label>
        ...
        <p style={{ fontSize: '75%', fontStyle: 'italic' }}>I göra-fasen dokumenterar vi resultaten från mätningarna av förbättringen med utgångspunkt i de valda mätetalen. <br></br> Hur gick genomförandet av testerna? Vilka synpunkter, iakttagelser och erfarenheter vill vi dokumentera? <br></br>Vilka händelser och hinder vill vi dokumentera? </p>
      </Form.Label>
      <textarea
