  ...
  return (
    <>
      <Form.Label>
        ...
        <p style={{ fontSize: '75%', fontStyle: 'italic' }}>Vill du anteckna något ytterligare som kan vara bra att veta i denna fas? <br></br> Skriv dina anteckningar i fältet nedan </p>
      </Form.Label>
      <textarea
